...
<html>
	...
	<body>
					...
					<div class="row">
						<div class="col-md-4 col-sm-4">
							...
							<div class="ab-item">
								...
								<!-- paragraph -->
								<p>Improve the user experience, it's the value that's unmatched.</p>
								<ul>
									<li>Youtube</li>
									<li>DailyMotion</li>
									<li>Vimeo</li>
						...
						<div class="col-md-4 col-sm-4">
							...
							<div class="ab-item">
								...
								<h3>Stream Video</h3>
								<!-- paragraph -->
								<p>Find the best video for your choice from your favourite video hosting sites </p>
								<br>
		...
		<form action="vresult" method="post">
		
			<button class="button" type="submit" name="submit" value="Stream Video"><span>Stream Video</span></button>
						...
						<div class="col-md-4 col-sm-4">
							...
							<div class="ab-item">
								...
								<!-- browse -->
								<p>Search videos using keywords or according to the date.</p>
								<br>
								
								
		<form action="vresult" method="post">
		
			<button style="background-color:#B942FA" class="button" type="submit" name="submit" value="Browse Video"><span>Browse Video</span></button>
					...
					<div class="row">
						<div class="col-md-4 col-sm-4">
							...
							<div class="event-item">
								<!-- image -->
								<img class="img-responsive" src="img/event/1x.jpg" alt="Events" />
								<!-- heading -->
