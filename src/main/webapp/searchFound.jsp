	...
	<div class="event" id="event">
				<div class="container">
					<div class="default-heading">
						...
						<h2 style="color:orange; font-weight: bold">Search results for keyword: <em style="color:#00001a"> <% String k=(String) session.getAttribute("key");  out.print(k);%> </em> </h2>
...
<c:forEach var = "video" items="${slist}">
